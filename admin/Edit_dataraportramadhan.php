...
$mhs=query("SELECT * FROM raport_ramadhan WHERE id_raport=$id")[0];
$rowid=$mhs['id_santri'];
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Edit Data Raport Ramadhan</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Home</a></li>
            <li class="breadcrumb-item active">Kelola Data Santri</li>
            <li class="breadcrumb-item active">Edit Data Raport Ramadhan</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
        ...
        <table align="left">
          <form action="#" class="inner-login" method="post" enctype="multipart/form-data">
            <tr>
              <td>
                <div class="form-group">
                  ...
                  <input type= "text" name="nama_santri" readonly value="<?php echo $mhs['nama_santri']; ?>" class="form-control" required> 
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td>
                <div class="form-group">
                  <label for="input-id" class="cal-sm-2">Kegiatan</label>
                  <input type= "text" name="kegiatan" value="<?php echo $mhs['kegiatan']; ?>" class="form-control" required> 
                </div>
              </td>
            </tr>
            <tr>
