          ...
          <div class="col-lg-12">
            ...
            <table align="left">
              <form action="#" class="inner-login" method="post" enctype="multipart/form-data">
                ...
                <tr>
                  <td>
                    <div class="form-group row">
                      ...
                      <div class="col-lg-12">
                        <input type="radio" name="jeniskelamin" value="L" <?php if ($mhs['jeniskelamin'] == 'L') {
                                                                            echo 'checked';
                                                                          } ?>> Laki-laki
                        <input type="radio" name="jeniskelamin" value="P" <?php if ($mhs['jeniskelamin'] == 'P') {
                                                                            echo 'checked';
                                                                          } ?>> Perempuan
                      </div>
                    </div>
                ...
                ?>
                  <td height="100">
                    <input class="btn btn-warning" type="submit" name="simpan" id="simpan" value="Simpan Perubahan" />
