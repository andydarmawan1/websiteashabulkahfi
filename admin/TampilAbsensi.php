      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            ...
            <!-- Membuat tabel -->
            <?php
            $absen = query("SELECT * FROM absen WHERE id_santri=$id ORDER BY tanggal DESC, waktu DESC");
            if (isset($_POST["cari"])) {
            ...
            ?>
              ...
              <a href="fpdf182/cetak_absensi.php" class="btn btn-success">
              ...
              <tbody>
                ...
                foreach ($absen as $row) :
                  ...
                  <tr>
                    ...
                    if ($_SESSION['level'] == 'superadmin') {
                    ?>
                      <td align="center"><a class="btn btn-info" href="edit_dataabsen.php?id=<?php echo $id_abs; ?>">Edit <br></td><!-- untuk ke tampilan edit -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <form action="delete_dataabsen.php?id=<?php echo $id_abs; ?>" method="POST">
